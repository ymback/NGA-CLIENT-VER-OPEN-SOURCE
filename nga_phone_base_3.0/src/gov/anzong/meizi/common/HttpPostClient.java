...
public class HttpPostClient {
    ...
    public HttpURLConnection post_body(String body) {
        ...
        final String USER_AGENT = new StringBuilder().append("Nga_Official/").append("3.0.0").append("(").append(machine).append(";Android").append(android.os.Build.VERSION.RELEASE).append(")").toString();
