...
public class MeiziHttpUtil {
    ...
    public final static String PATH_OLD = android.os.Environment
            .getExternalStorageDirectory().getPath() + "/nga_cache";
    ...
    // public static final String USER_AGENT = new
    // StringBuilder().append("Nga_Official/").append(MyApp.version).append("([Xiaomi MI 2S];Android").append(android.os.Build.VERSION.RELEASE).append(")").toString();
    // public static final String USER_AGENT = new
    // StringBuilder().append("Mozilla/5.0 (Linux; U; Android 2.3.3; zh-cn; SH12C Build/S4040) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1").toString();
    ...
    public static String getHtml(String uri, String cookie) {
        ...
        if (MODEL.indexOf(MANUFACTURER) >= 0) {
            ...
            machine = android.os.Build.MANUFACTURER + " "
                    + android.os.Build.MODEL;
        }
        if (machine.length() < 19) {
            machine = "[" + machine + "]";
        }
        final String USER_AGENT = new StringBuilder().append("Nga_Official/")
                .append(573).append("(").append(machine).append(";Android")
    ...
    public static String getHtml(String uri, String cookie, String host,
                                 int timeout) {
        InputStream is = null;
    ...
    public static String getHtmlFormeizi(String uri, String cookie) {
        return getHtmlFormeizi(uri, cookie, null);
    }

    @SuppressWarnings("deprecation")
    public static String getHtmlFormeizi(String uri, String cookie, String referer) {
        InputStream is = null;
        String machine = "";
        if (MODEL.indexOf(MANUFACTURER) >= 0) {
            machine = android.os.Build.MODEL;
