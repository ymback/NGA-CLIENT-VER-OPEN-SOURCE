...
OnChildFragmentRemovedListener,PullToRefreshAttacherOnwer, OnItemLongClickListener {
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view, int position,
		...
		builder.setMessage(this.getString(R.string.delete_favo_confirm_text)).setPositiveButton(R.string.confirm, dialogClickListener)
