...
public class StringUtil {
	...
	private static final String[] SAYING = {
			...
			"寻找NGA客户端开源版更新请在Google Play商店搜索并安装",
	...
	final static String tips = 	
			"发现bug后请先更新到最新版本,如果还有问题[@竹井詩織里]或[@cfan8],现在软件全称NGA客户端开源版,由开源版开发团队开发了\n"
			+"彩虹发帖模式及发送可见尾巴两个功能累计已招致禁言210天次以上,专供需要自杀的用户!\n"
			+"安卓4.0以上现在可以设置将发帖按钮放置在输入法上方了,独立于菜单按钮\n"
			+"设置中可选择2G/3G时图片中转压缩,使用新浪SAE处理\n"
			+"NGA客户端开源版开发团队([@竹井詩織里]/[@cfan8])再开发,赞美片总\n"
			+"寻找更新请在Google Play商店搜索NGA客户端开源版安装\n"
			+"178,准时坑爹,绝不发货";
