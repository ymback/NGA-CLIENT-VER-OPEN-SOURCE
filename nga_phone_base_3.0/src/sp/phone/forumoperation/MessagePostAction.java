...
public class MessagePostAction {
		...
		public String toString()
		{
			...
			sb.append("&act=");sb.append(action_);
			
			if(!action_.equals("new")){
				sb.append("&mid="); sb.append(String.valueOf(mid_));
			}
			sb.append("&to="); sb.append(to_);
			sb.append("&subject="); 
			sb.append(StringUtil.encodeUrl(post_subject_,"GBK"));
			sb.append("&content="); sb.append(StringUtil.encodeUrl(post_content_,"GBK"));
