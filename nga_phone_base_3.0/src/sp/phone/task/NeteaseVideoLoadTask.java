...
public class NeteaseVideoLoadTask extends AsyncTask<String, Integer, String> {
	...
	static final String dialogTag = "load_netease";
	public NeteaseVideoLoadTask(FragmentActivity fa,String origurl) {
		super();
		this.fa = fa;
	...
	protected void onPreExecute() {
		...
		final String content = fa.getResources().getString(R.string.load_netease_video);
	...
	protected void onPostExecute(String result) {
		...
		if(result != null){
		    VideoActivity.openVideo(fa, Uri.parse(result), "网易视频");
		}else{
