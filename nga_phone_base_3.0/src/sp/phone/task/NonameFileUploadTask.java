...
public class NonameFileUploadTask extends
AsyncTask<String, Integer, String> {
	private static final String TAG = NonameFileUploadTask.class.getSimpleName();
	private static final String BOUNDARY =
					"-----------------------------7db1c5232222b";
	private static final String ATTACHMENT_SERVER = "http://ngac.sinaapp.com/nganoname/attach.php?";
	private static final String LOG_TAG = NonameFileUploadTask.class.getSimpleName();
	...
	public NonameFileUploadTask(Context context, onFileUploaded notifier, Uri uri){
		this.context = context;
		this.notifier = notifier;
		this.uri = uri;
	}
	...
	protected void onPostExecute(String result) {
			Gson gson = new Gson();
			NonameUploadResponse response = gson.fromJson(result, NonameUploadResponse.class);
