...
public class DemoActivity extends TabActivity {
	...
	protected void onResume() {
		...
		super.onResume();
		int _FONT_RED=1,_FONT_BLUE=2,_FONT_GREEN=4,_FONT_ORANGE=8,_FONT_SILVER=16,_FONT_B=32,_FONT_I=64,_FONT_U=128;
        String s="AQAAACE";
        ...
        BigInteger src1= new BigInteger(sa,2);//转换为BigInteger类型
        Log.i("TAG",String.valueOf(src1));
        String sb=s.substring(8,s.length());
        Log.i("TAG",sb);
        BigInteger src2= new BigInteger(sb,2);//转换为BigInteger类型
        int d = src2.intValue();
