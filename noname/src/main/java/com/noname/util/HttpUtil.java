...
import com.noname.bean.ArticlePage;
...
public class HttpUtil {
    ...
    public static String getHtml(String uri, String cookie) {
        ...
        final String USER_AGENT = new StringBuilder().append("Nga_Official/").append(573).append("(").append(machine).append(";Android").append(Build.VERSION.RELEASE).append(")").toString();
        try {
            URL url = new URL(uri);
